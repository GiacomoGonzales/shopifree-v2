...
export default function BistroTheme({ store, products, categories, onWhatsAppClick, onProductView, onCartAdd }: Props) {
  ...
  return (
    <ThemeProvider theme={bistroTheme} store={store}>
      <div className="min-h-screen" style={{ backgroundColor: charcoal }}>
        ...
        {showAnnouncement && (
          <div
            className="relative py-3 px-4 text-center text-sm tracking-wider font-sans-bistro animate-fadeIn"
            style={{
              backgroundColor: store.announcement?.backgroundColor || wine,
