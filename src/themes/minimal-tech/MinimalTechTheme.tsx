/**
 * MINIMAL TECH THEME - "APPLE STYLE"
 *
 * Filosofia: Minimalismo premium, elegancia silenciosa.
 * - Paleta: Blancos puros, grises espaciales, negro profundo
 * - Tipografia: SF Pro / System UI, peso ligero y medio
 * - Cards con sombras sutiles, mucho espacio en blanco
...
export default function MinimalTechTheme({ store, products, categories, onWhatsAppClick, onProductView, onCartAdd }: Props) {
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center justify-between h-14">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <svg className="w-5 h-5" style={{ color: spaceGray }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            {store.whatsapp && (
              <a
                ...
                className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-full text-white font-medium transition-all hover:scale-105"
                style={{ backgroundColor: appleBlue }}
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
