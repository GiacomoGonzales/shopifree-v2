...
export default function MetroTheme({ store, products, categories, onWhatsAppClick, onProductView, onCartAdd }: Props) {
  ...
  return (
    <ThemeProvider theme={metroTheme} store={store}>
              ...
              <div className="flex items-center gap-3">
                {store.instagram && (
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-gray-100 transition-colors text-gray-500"
                  >
                ...
                <button
                  ...
                  style={{ backgroundColor: totalItems > 0 ? blue : 'transparent', color: totalItems > 0 ? '#fff' : dark }}
                >
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              {store.whatsapp && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium text-white transition-all hover:opacity-90 bg-[#25D366]"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
