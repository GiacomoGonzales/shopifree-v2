        ...
        {(store.heroImage || store.heroImageMobile) ? (
          ...
          <section className="py-20 md:py-32 text-center relative">
            ...
            <div className="max-w-4xl mx-auto px-6 relative">
              ...
              {store.about?.slogan && <p className="mt-5 text-lg" style={{ color: '#7B8BA8' }}><EditableText path="about.slogan" value={store.about?.slogan} /></p>}
              {store.whatsapp && (
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
              <FilterPanel
                ...
                colors={{
                  ...
                  primary: getPrimaryColor(store) || auroraTheme.colors.primary,
