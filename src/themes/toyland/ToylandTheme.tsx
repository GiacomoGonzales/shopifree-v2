...
export default function ToylandTheme({ store, products, categories, onWhatsAppClick, onProductView, onCartAdd }: Props) {
  ...
  return (
    <ThemeProvider theme={toylandTheme} store={store}>
      <div className="min-h-screen" style={{ backgroundColor: softWhite }}>
        ...
        {showAnnouncement && (
          <div
            className="relative py-3 px-4 text-center text-sm font-bold font-toyland animate-fadeIn"
            style={{
              backgroundColor: store.announcement?.backgroundColor || coral,
          ...
          >
            ...
            <StarIcon className="w-4 h-4 inline-block ml-2" />
            <button
