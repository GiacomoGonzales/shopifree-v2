  ...
  return (
    <ThemeProvider theme={auraTheme} store={store}>
      <div className="min-h-screen" style={{ backgroundColor: lavender }}>
        ...
        {showAnnouncement && (
          <div
            className="relative py-3 px-4 text-center text-sm tracking-wider font-aura-body animate-fadeIn"
            style={{
              backgroundColor: store.announcement?.backgroundColor || violet,
