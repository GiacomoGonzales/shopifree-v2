      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-14">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-emerald-600 text-sm mt-1">{filteredProducts.length} {filteredProducts.length === 1 ? t.item : t.items}</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <div className="flex items-center gap-4 mb-4">
                {store.logo ? (
                  <img src={store.logo} alt={store.name} className="h-16 w-16 object-cover rounded-full border-2 border-emerald-200" />
                ) : (
                  <div className="h-16 w-16 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full flex items-center justify-center border-2 border-emerald-200">
              ...
              <div className="flex items-center gap-3">
                {store.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full flex items-center justify-center text-white hover:from-emerald-500 hover:to-teal-600 transition-all hover:scale-110"
          ...
          <div className="max-w-xl mx-auto bg-emerald-600 rounded-2xl shadow-2xl shadow-emerald-600/30 p-4 flex items-center justify-between gap-4">
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs text-emerald-100">{t.view} {t.cart.toLowerCase()}</p>
