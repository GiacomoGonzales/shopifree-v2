      ...
      <footer className="border-t border-gray-100 mt-12">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
              ...
              <div className="flex items-center gap-3">
                {store.logo ? (
                  ...
                  <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
                    <span className="text-lg font-semibold text-gray-600">{store.name.charAt(0)}</span>
                  </div>
                )}
            ...
            {/* Column 2: Contact */}
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">{t.contact}</h3>
              <div className="space-y-3">
                ...
                {store.location && (store.location.address || store.location.city) && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-3 text-sm text-gray-600 hover:text-gray-900 transition-colors"
                  >
                    <svg className="w-5 h-5 text-gray-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
            ...
            {(store.instagram || store.facebook || store.tiktok) && (
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">{t.followUs}</h3>
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin p-6">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-gray-400 text-lg">{t.noItems}</p>
                  <p className="text-gray-300 text-sm mt-1">{t.checkBackSoon}</p>
                </div>
              ) : (
