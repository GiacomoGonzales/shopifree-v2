      ...
      <footer style={{ backgroundColor: paper }}>
        <div className="max-w-5xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {/* Column 2 - Contacto */}
            <div>
              <h3 className="font-craft-title text-lg mb-4" style={{ color: darkText }}>{t.contact}</h3>
            ...
            {/* Column 3 - Siguenos */}
            <div>
              <h3 className="font-craft-title text-lg mb-4" style={{ color: darkText }}>{t.followUs}</h3>
              <div className="flex items-center gap-3">
                {store.instagram && (
                  <a
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs" style={{ color: `${cream}70` }}>{t.view} {t.cart.toLowerCase()}</p>
        ...
        <div className="fixed inset-0 z-[60] animate-fadeIn" onClick={() => setIsCartOpen(false)}>
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b" style={{ borderColor: `${warmBrown}15` }}>
              <h2 className="font-craft-title text-xl" style={{ color: darkText }}>{t.cart}</h2>
              <button
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <p className="font-craft-body text-lg" style={{ color: warmBrown }}>{t.noItems}</p>
                  <p className="font-craft-body text-sm mt-1" style={{ color: `${warmBrown}60` }}>{t.checkBackSoon}</p>
                </div>
              ) : (
            ...
            {items.length > 0 && (
              <div className="p-6 border-t" style={{ borderColor: `${warmBrown}15` }}>
                <div className="flex justify-between items-center mb-4">
                  <span className="font-craft-body" style={{ color: warmBrown }}>{t.total}</span>
