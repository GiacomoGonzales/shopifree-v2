        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-10">
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="w-10 h-px" style={{ backgroundColor: `${warmBrown}30` }} />
              {store.logo ? (
            ...
            <h3 className="font-craft-title text-2xl mb-2" style={{ color: darkText }}>{store.name}</h3>
            {store.about?.description && (
              <p className="font-craft-body max-w-md mx-auto" style={{ color: warmBrown }}>{store.about.description}</p>
            )}
          </div>
          ...
          {/* Bottom */}
          <div className="pt-8 border-t text-center" style={{ borderColor: `${warmBrown}15` }}>
            <p className="font-craft-body text-sm mb-3" style={{ color: `${warmBrown}60` }}>
              {new Date().getFullYear()} {store.name}. Hecho con amor.
            </p>
            <a
