    ...
    <div className="min-h-screen" style={{ backgroundColor: light }}>
      ...
      <footer style={{ backgroundColor: dark }}>
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                {store.logo ? (
                  <div className="w-14 h-14 rounded-2xl overflow-hidden" style={{ backgroundColor: purple }}>
                    <img src={store.logo} alt={store.name} className="w-full h-full object-contain" />
                  </div>
                ) : (
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: `linear-gradient(135deg, ${purple}, ${pink})` }}>
                    <span className="font-pop font-black text-2xl" style={{ color: light }}>{store.name.charAt(0)}</span>
                  </div>
                )}
                <h3 className="font-pop font-black text-xl" style={{ color: light }}>{store.name}</h3>
              </div>
              {store.about?.description && (
                <p className="font-pop text-sm leading-relaxed" style={{ color: `${light}70` }}>{store.about.description}</p>
              )}
            </div>
              ...
              <div className="space-y-3">
                {store.whatsapp && (
                  <a
                    ...
                    style={{ color: `${light}80` }}
                  >
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: blue, color: light }}>
                    ...
                    <span className="font-pop text-sm">{store.whatsapp}</span>
                  </a>
                )}
                {store.email && (
                  <a
                    ...
                    style={{ color: `${light}80` }}
                  >
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: purple, color: light }}>
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                      </svg>
                    </div>
                    <span className="font-pop text-sm">{store.email}</span>
                  </a>
                )}
                {store.location && (store.location.address || store.location.city) && (
                  <a
                    ...
                    style={{ color: `${light}80` }}
                  >
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: orange, color: light }}>
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                      </svg>
                    </div>
                    <span className="font-pop text-sm pt-2">{[store.location.address, store.location.city, store.location.country].filter(Boolean).join(', ')}</span>
                  </a>
                )}
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                {store.tiktok && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-2xl flex items-center justify-center transition-all hover:scale-110"
                    style={{ backgroundColor: purple, color: light }}
                    title="TikTok"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Bottom */}
          <div className="mt-12 pt-8 border-t text-center md:text-left md:flex md:items-center md:justify-between" style={{ borderColor: `${light}15` }}>
            <p className="font-pop text-sm mb-3 md:mb-0" style={{ color: `${light}50` }}>
