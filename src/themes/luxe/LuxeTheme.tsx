        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
            ...
            <div className="text-center md:text-left">
              {store.logo ? (
                <img src={store.logo} alt={store.name} className="w-14 h-14 object-contain rounded-full mx-auto md:mx-0 mb-4" />
              ) : (
                <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto md:mx-0 mb-4" style={{ backgroundColor: gold }}>
                  <span className="font-serif-luxe text-xl" style={{ color: darkBg }}>{store.name.charAt(0)}</span>
                </div>
              )}
              <h3 className="font-serif-luxe text-xl text-white mb-2">{store.name}</h3>
            ...
            {/* Column 2: Contacto */}
            <div className="text-center md:text-left">
              <h4 className="font-serif-luxe text-sm tracking-widest uppercase mb-4" style={{ color: gold }}>{t.contact}</h4>
              <div className="space-y-3">
                {store.whatsapp && (
                  <a
                    ...
                    className="flex items-center justify-center md:justify-start gap-2 text-sm text-white/70 hover:text-white transition-colors"
                  >
            ...
            {/* Column 3: Siguenos */}
            <div className="text-center md:text-left">
              <h4 className="font-serif-luxe text-sm tracking-widest uppercase mb-4" style={{ color: gold }}>{t.followUs}</h4>
              <div className="flex items-center justify-center md:justify-start gap-4">
                {store.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 border flex items-center justify-center transition-all duration-300 hover:border-opacity-100"
          ...
          {/* Bottom */}
          <div className="mt-12 pt-8 border-t flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-center md:text-left" style={{ borderColor: `${gold}20` }}>
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs text-white/50 uppercase tracking-wider">{t.view} {t.cart.toLowerCase()}</p>
        ...
        <div className="fixed inset-0 z-[60] animate-fadeIn" onClick={() => setIsCartOpen(false)}>
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b" style={{ borderColor: `${gold}30` }}>
              <h2 className="font-serif-luxe text-xl" style={{ color: darkBg }}>{t.cart}</h2>
              <button
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-lg" style={{ color: `${darkBg}60` }}>{t.noItems}</p>
                  <p className="text-sm mt-2" style={{ color: `${darkBg}40` }}>{t.checkBackSoon}</p>
                </div>
              ) : (
            ...
            {items.length > 0 && (
              <div className="p-6 border-t" style={{ borderColor: `${gold}30` }}>
                <div className="flex justify-between items-center mb-6">
                  <span className="text-sm uppercase tracking-wider" style={{ color: `${darkBg}60` }}>{t.total}</span>
