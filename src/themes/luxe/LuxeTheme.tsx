      ...
      <footer style={{ backgroundColor: darkBg }}>
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
            ...
            {/* Column 2: Contacto */}
            <div className="text-center md:text-left">
              <h4 className="font-serif-luxe text-sm tracking-widest uppercase mb-4" style={{ color: gold }}>Contacto</h4>
            ...
            {/* Column 3: Siguenos */}
            <div className="text-center md:text-left">
              <h4 className="font-serif-luxe text-sm tracking-widest uppercase mb-4" style={{ color: gold }}>Siguenos</h4>
