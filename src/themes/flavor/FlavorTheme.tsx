  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: lightCream }}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="font-bold" style={{ color: brown }}>Menu vacio</p>
              <p className="text-sm mt-1" style={{ color: warmGray }}>Pronto agregaremos deliciosos platillos</p>
            </div>
          )}
        </div>
      </main>
      ...
      <footer style={{ backgroundColor: brown }} className="py-12 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              {store.logo ? (
                <img src={store.logo} alt={store.name} className="h-10 w-auto mb-4" />
              ) : (
            ...
            {/* Contact */}
            <div>
              <h4 className="font-bold mb-4" style={{ color: orange }}>Contacto</h4>
            ...
            {/* Location */}
            <div>
              <h4 className="font-bold mb-4" style={{ color: orange }}>Ubicacion</h4>
              {store.location && (
                <p className="text-sm opacity-80">
                  {[store.location.address, store.location.city, store.location.country].filter(Boolean).join(', ')}
                </p>
              )}
            </div>
          </div>
      ...
      {store.whatsapp && totalItems === 0 && (
        <a
          href={`https://wa.me/${store.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent(`Hola! Quiero hacer un pedido de ${store.name}`)}`}
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => onWhatsAppClick?.()}
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs opacity-60">Ver pedido</p>
          ...
          >
            ...
            <div className="p-4 flex-shrink-0" style={{ backgroundColor: cream }}>
              <div className="flex justify-between items-center mb-4">
                <span className="font-semibold" style={{ color: warmGray }}>Total</span>
