  ...
  return (
    <ThemeProvider theme={velvetTheme} store={store}>
      ...
      <div className="min-h-screen relative" style={{ backgroundColor: bg, fontFamily: "'Lato', system-ui, sans-serif" }}>
        ...
        {(store.heroImage || store.heroImageMobile) ? (
          <section ref={heroRef} className="relative overflow-hidden">
            <div className="md:hidden relative">
              <HeroImg ref={heroImgMobileRef} src={store.heroImageMobile || store.heroImage} alt={store.name} className="w-full h-auto max-h-[400px] object-cover" style={{ filter: 'brightness(0.75) contrast(1.15) saturate(0.9)' }} />
            ...
            <div className="hidden md:block relative aspect-[16/5] overflow-hidden">
              <HeroImg ref={heroImgRef} src={store.heroImage || store.heroImageMobile} alt={store.name} className="w-full h-full object-cover" style={{ transform: 'scale(1.1)', filter: 'brightness(0.75) contrast(1.15) saturate(0.9)' }} />
        ...
        <TrustBar />
        <FlashSaleBar />
        <CategoryCarousel categories={categories} activeCategory={activeFilters.categoryId} onCategoryChange={(id) => setFilter('categoryId', id)} products={products} onSelectProduct={handleSelectProduct} variant="tile" />
