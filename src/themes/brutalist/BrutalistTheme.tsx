/**
 * BRUTALIST THEME - "ANTI-DESIGN / RAW"
 *
 * Filosofia: Anti-diseno, crudo, tipografia monospace gigante.
 * - Paleta: Negro, blanco, rojo crudo como unico acento
 * - Tipografia: Monospace bold, titulos enormes
 * - Sin bordes redondeados, bordes gruesos, layout crudo
 * - Estetica de terminal/manifiesto/poster punk
 * - Ideal para: Marcas independientes, arte, studios creativos
 */
...
export default function BrutalistTheme({ store, products, categories, onWhatsAppClick, onProductView, onCartAdd }: Props) {
  ...
  return (
    <ThemeProvider theme={brutalistTheme} store={store}>
      ...
      >
              ...
              <div className="flex items-center gap-3">
                {store.instagram && (
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center border-2 border-black transition-all hover:bg-black hover:text-white"
                  >
                ...
                <button
                  ...
                  className="relative flex items-center gap-2 px-4 py-2 font-bold uppercase text-sm transition-all"
                  style={{
                    backgroundColor: totalItems > 0 ? '#FF0000' : '#FFFFFF',
                    color: totalItems > 0 ? '#FFFFFF' : '#000000',
        ...
        {(store.heroImage || store.heroImageMobile) ? (
          ...
          <section className="py-16 md:py-24 text-center relative" style={{ borderBottom: '3px solid #000000' }}>
            <div className="max-w-4xl mx-auto px-6">
              ...
              {store.whatsapp && (
                <a
                  ...
                  className="inline-flex items-center gap-2 mt-8 px-6 py-3 font-bold uppercase text-sm transition-all hover:-translate-x-0.5 hover:-translate-y-0.5"
                  style={{
        ...
        <main className="py-10" style={{ backgroundColor: '#FFFFFF' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
