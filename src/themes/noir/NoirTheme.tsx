        ...
        {(store.heroImage || store.heroImageMobile) ? (
          <section ref={heroRef} className="relative overflow-hidden">
            <div className="md:hidden relative">
              <HeroImg ref={heroImgMobileRef} src={store.heroImageMobile || store.heroImage} alt={store.name} className="w-full h-auto max-h-[400px] object-cover" style={{ filter: 'contrast(1.1) brightness(0.9)' }} />
            ...
            <div className="hidden md:block relative aspect-[16/5] overflow-hidden">
              <HeroImg ref={heroImgRef} src={store.heroImage || store.heroImageMobile} alt={store.name} className="w-full h-full object-cover" style={{ transform: 'scale(1.1)', filter: 'contrast(1.1) brightness(0.9)' }} />
