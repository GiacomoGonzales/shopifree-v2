        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="font-medium" style={{ color: darkBrown }}>{t.noItems}</p>
              <p className="text-sm mt-1 italic" style={{ color: sepia }}>{t.checkBackSoon}</p>
            </div>
          )}
        </div>
      </main>
      ...
      <footer style={{ backgroundColor: darkBrown, color: cream }} className="py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Contacto */}
            <div className="text-center md:text-left">
              <h4 className="font-medium mb-4 tracking-wide" style={{ color: gold }}>{t.contact}</h4>
            ...
            {/* Siguenos */}
            <div className="text-center md:text-left">
              <h4 className="font-medium mb-4 tracking-wide" style={{ color: gold }}>{t.followUs}</h4>
                ...
                <div className="mt-4 pt-4 space-y-2" style={{ borderTop: `1px solid ${lightBrown}` }}>
                  {selectedProduct.brand && (
                    <p className="text-sm" style={{ color: sepia }}>
                      <span className="font-medium" style={{ color: darkBrown }}>{t.brand}:</span> {selectedProduct.brand}
                    </p>
                  )}
                  {selectedProduct.sku && (
                    <p className="text-sm" style={{ color: sepia }}>
                      <span className="font-medium" style={{ color: darkBrown }}>{t.sku}:</span> {selectedProduct.sku}
                    </p>
                  )}
                </div>
              )}
          ...
          >
            ...
            <div className="p-4 flex-shrink-0" style={{ borderTop: `2px solid ${lightBrown}` }}>
              <div className="flex justify-between items-center mb-4">
                <span className="font-medium" style={{ color: sepia }}>{t.total}</span>
