      ...
      <footer className="border-t mt-12" style={{ borderColor: `${neonGreen}20`, backgroundColor: `${neonGreen}05` }}>
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {/* Column 2 - Contacto */}
            <div>
              <h3 className="font-semibold text-lg mb-5 neon-glow" style={{ color: neonGreen }}>Contacto</h3>
            ...
            {/* Column 3 - Siguenos */}
            <div>
              <h3 className="font-semibold text-lg mb-5 neon-glow-cyan" style={{ color: neonCyan }}>Siguenos</h3>
