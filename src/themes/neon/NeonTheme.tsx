      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-14">
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-white/50 text-lg">{t.noItems}</p>
          </div>
        ) : (
      ...
      <footer className="border-t mt-12" style={{ borderColor: `${neonGreen}20`, backgroundColor: `${neonGreen}05` }}>
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="flex flex-col items-start gap-4 mb-4">
                {store.logo ? (
                  <div
                    ...
                    style={{ boxShadow: `0 0 15px ${neonGreen}50, 0 0 30px ${neonGreen}30` }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 15px ${neonGreen}50, 0 0 30px ${neonGreen}30`
                    }}
                  >
                    <span className="font-bold text-2xl neon-glow" style={{ color: neonGreen }}>{store.name.charAt(0)}</span>
                  </div>
                )}
            ...
            {/* Column 2 - Contacto */}
            <div>
              <h3 className="font-semibold text-lg mb-5 neon-glow" style={{ color: neonGreen }}>{t.contact}</h3>
              <div className="space-y-4">
                ...
                {store.location && (store.location.address || store.location.city) && (
                  ...
                  >
                    ...
                    >
                      <svg className="w-5 h-5" style={{ color: neonCyan }} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                      </svg>
                    </div>
                    <span className="text-sm">{[store.location.address, store.location.city, store.location.country].filter(Boolean).join(', ')}</span>
                  </a>
                )}
              </div>
            </div>
            ...
            {/* Column 3 - Siguenos */}
            <div>
              <h3 className="font-semibold text-lg mb-5 neon-glow-cyan" style={{ color: neonCyan }}>{t.followUs}</h3>
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 10px ${neonCyan}00`
                      }}
                      onMouseEnter={(e) => e.currentTarget.style.boxShadow = `0 0 20px ${neonCyan}60`}
                      onMouseLeave={(e) => e.currentTarget.style.boxShadow = `0 0 10px ${neonCyan}00`}
                    >
                      <svg className="w-6 h-6" style={{ color: neonCyan }} fill="currentColor" viewBox="0 0 24 24">
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${neonGreen}30`,
                        boxShadow: `0 0 10px ${neonGreen}00`
                      }}
                      onMouseEnter={(e) => e.currentTarget.style.boxShadow = `0 0 20px ${neonGreen}60`}
                      onMouseLeave={(e) => e.currentTarget.style.boxShadow = `0 0 10px ${neonGreen}00`}
                    >
                      <svg className="w-6 h-6" style={{ color: neonGreen }} fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs text-white/50">{t.view} {t.cart}</p>
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin p-6">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-white/50 text-lg">{t.noItems}</p>
                  <p className="text-white/30 text-sm mt-1">{t.checkBackSoon}</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {items.map(item => (
