...
import LiquidTheme from './liquid/LiquidTheme'
import GlacierTheme from './glacier/GlacierTheme'
import VelvetTheme from './velvet/VelvetTheme'
import HologramTheme from './hologram/HologramTheme'
import VaporTheme from './vapor/VaporTheme'
import MirageTheme from './mirage/MirageTheme'
import EditorialTheme from './editorial/EditorialTheme'
...
import GazetteTheme from './gazette/GazetteTheme'
import PaperCutTheme from './papercut/PaperCutTheme'
import ZineTheme from './zine/ZineTheme'
import CartographyTheme from './cartography/CartographyTheme'
import TerminalTheme from './terminal/TerminalTheme'
import WatercolorTheme from './watercolor/WatercolorTheme'
import DinerTheme from './diner/DinerTheme'
import BauhausTheme from './bauhaus/BauhausTheme'
import CaratTheme from './carat/CaratTheme'
import ClayTheme from './clay/ClayTheme'
import ReceiptTheme from './receipt/ReceiptTheme'
import ChatTheme from './chat/ChatTheme'
import DesktopTheme from './desktop/DesktopTheme'
import BoardingPassTheme from './boardingpass/BoardingPassTheme'
import CassetteTheme from './cassette/CassetteTheme'
import TabloidTheme from './tabloid/TabloidTheme'
import VendingTheme from './vending/VendingTheme'
import PassportTheme from './passport/PassportTheme'
import TagTheme from './tag/TagTheme'
import MenuTheme from './menu/MenuTheme'
import AppointmentTheme from './appointment/AppointmentTheme'
import EditorTheme from './editor/EditorTheme'
import SwatchTheme from './swatch/SwatchTheme'
import NutritionTheme from './nutrition/NutritionTheme'
import PetcardTheme from './petcard/PetcardTheme'
import FiestaTheme from './fiesta/FiestaTheme'
...
export const themeComponents: Record<string, React.ComponentType<any>> = {
  ...
  vinyl: VinylTheme,
  gazette: GazetteTheme,
  papercut: PaperCutTheme,
  zine: ZineTheme,
  cartography: CartographyTheme,
  ...
  carat: CaratTheme,
  clay: ClayTheme,
  receipt: ReceiptTheme,
  chat: ChatTheme,
  desktop: DesktopTheme,
  boardingpass: BoardingPassTheme,
  cassette: CassetteTheme,
  tabloid: TabloidTheme,
  vending: VendingTheme,
  ...
  editor: EditorTheme,
  swatch: SwatchTheme,
  nutrition: NutritionTheme,
  petcard: PetcardTheme,
  fiesta: FiestaTheme,
}
