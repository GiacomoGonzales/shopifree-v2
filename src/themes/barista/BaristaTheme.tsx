  ...
  return (
    <ThemeProvider theme={baristaTheme} store={store}>
      <div className="min-h-screen" style={{ backgroundColor: cream }}>
        ...
        {showAnnouncement && (
          <div
            className="relative py-3 px-4 text-center text-sm font-medium font-barista-body animate-fadeIn"
            style={{
              backgroundColor: store.announcement?.backgroundColor || coffee,
              color: store.announcement?.textColor || cream
            }}
          >
            <CoffeeIcon className="w-4 h-4 inline-block mr-2" />
            ...
            <CoffeeIcon className="w-4 h-4 inline-block ml-2" />
            <button
