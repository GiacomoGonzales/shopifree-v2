...
export default function TrattoriaTheme({ store, products, categories, onWhatsAppClick, onProductView, onCartAdd }: Props) {
  ...
  return (
    <ThemeProvider theme={trattoriaTheme} store={store}>
      <div className="min-h-screen" style={{ backgroundColor: warmWhite }}>
        ...
        {showAnnouncement && (
          <div
            className="relative py-3 px-4 text-center text-sm font-trattoria-body animate-fadeIn"
            style={{
