          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              {store.logo ? (
                ...
                <h3 className="text-lg font-black uppercase tracking-tight mb-4" style={{ color: white }}>{store.name}</h3>
              )}
            ...
            {/* Contact */}
            <div>
              <h4 className="font-black uppercase tracking-widest text-xs mb-4" style={{ color: neon }}>Contact</h4>
            ...
            {/* Location */}
            <div>
              <h4 className="font-black uppercase tracking-widest text-xs mb-4" style={{ color: neon }}>Location</h4>
              {store.location && (
                <p className="text-xs" style={{ color: lightGray }}>
