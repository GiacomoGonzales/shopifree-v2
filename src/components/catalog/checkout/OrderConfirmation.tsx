  ...
  return (
    <div className="flex flex-col items-center text-center gap-6 py-4">
      ...
      <button
        ...
        className="w-full py-3.5 font-medium transition-all flex items-center justify-center gap-2 hover:opacity-90"
        style={{
      ...
      {/* WhatsApp section - always show when store has whatsapp */}
      {hasWhatsApp && (
        <a
          href={whatsappUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="w-full py-3.5 font-semibold transition-all flex items-center justify-center gap-3 hover:opacity-90 active:scale-[0.98]"
          style={{
