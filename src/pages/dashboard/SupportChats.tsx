    ...
    <div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" style={{ height: 'calc(100vh - 220px)', minHeight: '400px' }}>
        <div className="flex h-full">
          {/* Chat list */}
          <div className={`w-full lg:w-80 lg:border-r border-gray-100 flex flex-col ${showingConversation ? 'hidden lg:flex' : 'flex'}`}>
          ...
          {/* Conversation */}
          <div className={`flex-1 flex flex-col ${showingConversation ? 'flex' : 'hidden lg:flex'}`}>
            {selectedChat ? (
              <>
                {/* Conversation header */}
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center px-6">
                <svg className="w-16 h-16 text-gray-200 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                </svg>
