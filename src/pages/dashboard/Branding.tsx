  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        {/* Hero Image */}
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-[#1e3a5f] mb-4">Imagen de portada</h2>
          <p className="text-sm text-gray-600 mb-4">
            Esta imagen aparece en la parte superior de tu catalogo. Usa un ratio 3:2 horizontal (ej: 1200x800px) para mejores resultados.
          </p>
          <div
            onClick={() => heroInputRef.current?.click()}
            className="w-full max-w-md aspect-[3/2] bg-gradient-to-br from-[#f0f7ff] to-white border-2 border-dashed border-[#38bdf8]/30 rounded-2xl overflow-hidden cursor-pointer hover:border-[#38bdf8] transition-all flex items-center justify-center"
          >
            {uploadingHero ? (
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#2d6cb5]"></div>
            ) : heroImage ? (
              ...
              <div className="text-center p-8">
                <div className="w-14 h-14 bg-gradient-to-br from-[#38bdf8] to-[#2d6cb5] rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-lg shadow-[#38bdf8]/20">
                  <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                </div>
                <p className="text-[#1e3a5f] font-medium">Click para subir</p>
                <p className="text-gray-400 text-sm mt-1">Ratio 3:2 horizontal</p>
              </div>
            )}
          </div>
          <input
