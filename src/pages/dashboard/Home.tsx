        ...
        <div className="space-y-3 sm:space-y-0 sm:flex sm:items-center sm:gap-3">
          ...
          <div className="flex gap-2 sm:flex-shrink-0">
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-4 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition text-sm font-medium flex items-center justify-center gap-2 shadow-lg shadow-green-600/20"
            >
