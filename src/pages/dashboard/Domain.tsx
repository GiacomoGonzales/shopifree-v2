                    ...
                    {hasDomainConfigured ? (
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          {!isVerified && (
                            <button
                              ...
                              disabled={verifying}
                              className="flex-1 px-4 py-2.5 bg-[#1e3a5f] text-white rounded-xl hover:bg-[#2d6cb5] transition-all text-sm font-semibold disabled:opacity-50"
                            >
                      ...
                      <div className="space-y-4">
                        ...
                        <button
                          ...
                          className="w-full px-4 py-2.5 bg-[#1e3a5f] text-white rounded-xl hover:bg-[#2d6cb5] transition-all text-sm font-semibold shadow-sm disabled:opacity-50"
                        >
                  ...
                  <div className="bg-gray-50 border border-gray-200/60 rounded-xl p-4">
                    ...
                    {!Capacitor.isNativePlatform() && (
                      <button
                        ...
                        className="w-full px-4 py-2.5 bg-[#1e3a5f] text-white rounded-xl hover:bg-[#2d6cb5] transition-all text-sm font-semibold shadow-sm"
                      >
