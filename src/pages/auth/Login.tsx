      ...
      <div className="flex-1 flex flex-col px-6">
        ...
        <div className="w-full max-w-md mx-auto mt-8 pb-8">
          ...
          <div className="mt-6">
            ...
            {/* Google sign-in is hidden on iOS: the @codetrix-studio plugin
                crashes on iPhone 17 Pro Max + iOS 26.4 (Apple review device),
                and 4.8 also requires Sign in with Apple as the equivalent
                privacy-preserving option, which we already render above. */}
            {!isIOS && (
              <button
