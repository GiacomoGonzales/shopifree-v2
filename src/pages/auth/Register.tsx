...
export default function Register() {
  ...
  const { register, loginWithGoogle, loginWithApple, refreshStore, firebaseUser, store, loading: authLoading } = useAuth()
  ...
  const handleAppleRegister = async () => {
    ...
    try {
      ...
      if (!(msg.includes('1001') || msg.toLowerCase().includes('cancel'))) {
        setError(msg || t('register.appleError', { defaultValue: 'Error al registrarse con Apple' }))
      }
    } finally {
      setLoading(false)
    }
          ...
          <div>
            {!creationComplete ? (
              <>
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#38bdf8] to-[#2d6cb5] rounded-xl flex items-center justify-center shadow-lg shadow-[#38bdf8]/30 animate-pulse">
              ...
              <>
                {/* Success state */}
                <div className="flex justify-center mb-6">
                  <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-green-500 rounded-xl flex items-center justify-center shadow-lg shadow-green-500/30 animate-bounce">
                ...
                {/* Store link */}
                <div className="p-4 bg-[#1e3a5f] rounded-xl">
          ...
          {step === 1 && (
            <>
              ...
              <div className="mt-6">
                ...
                {/* Sign in with Apple — iOS only. Per HIG, Apple goes on top. */}
                {isIOS && (
                  <button
                  ...
                  >
                    ...
                    {t('register.apple', { defaultValue: 'Continuar con Apple' })}
                  </button>
                )}

                {/* Sign up with Google — available on all platforms.
                    Re-enabled on iOS after App Store approval. */}
                <button
