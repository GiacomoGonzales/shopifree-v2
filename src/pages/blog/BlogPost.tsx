...
export default function BlogPost() {
  ...
  return (
    <>
      <Seo
        title={`${post.title} | Blog Shopifree`}
        ...
        schemas={[
          {
            ...
            inLanguage: 'es',
            author: { '@type': 'Organization', name: post.author, url: 'https://shopifree.app' },
            publisher: {
              '@type': 'Organization',
              name: 'Shopifree',
          ...
          },
          {
            ...
            '@type': 'BreadcrumbList',
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Inicio', item: 'https://shopifree.app/es' },
              { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://shopifree.app/es/blog' },
