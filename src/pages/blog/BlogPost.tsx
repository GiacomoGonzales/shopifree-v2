      ...
      <div className="min-h-screen bg-gradient-to-b from-[#f0f7ff] to-white">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link
                  ...
                  className="px-4 py-2 bg-[#1e3a5f] text-white rounded-lg text-sm font-medium hover:shadow-lg transition-all"
                >
                  Crear tienda gratis
                </Link>
              </div>
        ...
        <article className="py-8 sm:py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            {/* CTA Box */}
            <div className="mt-12 p-6 sm:p-8 bg-[#1e3a5f] rounded-2xl text-center">
            ...
            <div className="mt-12 p-6 bg-white rounded-2xl border border-gray-100 flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#1e3a5f] to-[#1e3a5f] flex items-center justify-center text-white font-bold text-xl">
